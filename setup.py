...
# Everything the SpyRL recipe (spyrl/) needs on top of the verl core:
# a vLLM rollout engine, the HTTP server it is driven through, and HF dataset streaming.
# flash-attn is intentionally left out -- it has to be built after torch is importable,
# see setup.sh.
SPYRL_REQUIRES = [
    "vllm>=0.8.5,<=0.12.0",
    "tensordict>=0.8.0,<=0.10.0,!=0.9.0",
